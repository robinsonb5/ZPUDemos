...
xst -ifn xst.scr
move EMS11_BB21_sysclk_fb_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\EMS11_BB21_sysclk_fb_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc EMS11_BB21_sysclk_fb_exdes.ucf EMS11_BB21_sysclk_fb_exdes

echo 'Running map'
map -timing -pr b EMS11_BB21_sysclk_fb_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm EMS11_BB21_sysclk_fb_exdes -w routed.ncd routed.vhd
cd ..
